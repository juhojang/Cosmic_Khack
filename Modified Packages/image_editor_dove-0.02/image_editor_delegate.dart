...
class DefaultImageEditorDelegate extends ImageEditorDelegate{
  ...
  Color operatorStatuscolor(bool choosen) => choosen ? Colors.greenAccent : Colors.grey;
  ...
  Widget backBtnWidget(double limitSize) {
    return Icon(Icons.arrow_back_ios_new, size: limitSize,color: Colors.greenAccent,);
  }
  ...
  @override
  Widget undoWidget(double limitSize) => Icon(Icons.undo, size: limitSize, color: Colors.greenAccent);
...
abstract class ImageEditorDelegate{
  ...
  final BoxConstraints _doneWidgetCons = BoxConstraints(maxHeight: 10, maxWidth: 60);
